...
<body>
	<div id="background">
		<div id="page">
			...
			<?php
$conn=new PDO('mysql:host=localhost; dbname=industriyal', 'root', '') or die(mysql_error());
...
if($query){
echo"<script>alert('APPRUVAL success!'); location.href='staff.php';</script>";
}
else{
die(mysql_error());
}
